...
router.put('/api/my/transactions/:id/edit', authenticateUser('json'), (await import('./controllers/api/my/transactions/update.js')).default)
...
router.get('/my/transactions/edit/:id', authenticateUser('html'), (await import('./controllers/pages/my/transactions/edit.js')).default)
