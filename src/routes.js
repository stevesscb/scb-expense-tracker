...
router.put('/api/my/transactions/:id', authenticateUser('json'), (await import('./controllers/api/my/transactions/update.js')).default)
router.get('/api/my/transactions/:id', authenticateUser('json'), (await import('./controllers/api/my/transactions/show.js')).default)
